...
<body>
    <section class="vh-100">
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center aling-intems-center h-100">
                <div class="jubotron">
                    <!-- cabeçalho da pagina -->
                    <div class="row">
    ...
    <div class="d-flex flex-column flex-md-row text-center text-md-strt justify-content-between py-4 px-4 px-x1-5gab-primary">
